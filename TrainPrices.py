...
if __name__ == '__main__':
	TrainTickerRaw('F', UseLSTM=False, useGenericModel=False, prediction_target_days = 5, epochs = 400)
	#TrainTickerRaw('JNJ', UseLSTM=False, useGenericModel=False, prediction_target_days = 5, epochs = 400)
	#TrainTickerRaw('MSFT', UseLSTM=False, useGenericModel=False, prediction_target_days = 5, epochs = 400)
	#TrainTickerRaw('XOM', UseLSTM=False, useGenericModel=False, prediction_target_days = 5, epochs = 400)
	#TrainTickerRaw('F', UseLSTM=False, useGenericModel=True, prediction_target_days = 5, epochs = 2)
	#TrainTickerRaw('JNJ', UseLSTM=False, useGenericModel=True, prediction_target_days = 5, epochs = 100)
	#TrainTickerRaw('MSFT', UseLSTM=False, useGenericModel=True, prediction_target_days = 5, epochs = 100)
	#TrainTickerRaw('XOM', UseLSTM=False, useGenericModel=True, prediction_target_days = 5, epochs = 100)
	#TrainTickerRaw('F', UseLSTM=True, useGenericModel=True, prediction_target_days = 5, epochs = 200)
	#TrainTickerRaw('JNJ', UseLSTM=True, useGenericModel=True, prediction_target_days = 5, epochs = 0)
	#TrainTickerRaw('MSFT', UseLSTM=True, useGenericModel=True, prediction_target_days = 5, epochs = 0)
	#TrainTickerRaw('XOM', UseLSTM=True, useGenericModel=True, prediction_target_days = 5, epochs = 0)	
	...
	#TestPredictionModels('JNJ', 100)
	#TestPredictionModels('MSFT', 100)
	#TestPredictionModels('XOM', 100)
	TestPredictionModels('TSLA', 100)
