class TickerLists:
	def SPTop70():return ['AAPL','MSFT','AMZN','FB','BRK-B','JPM','JNJ','XOM','GOOG','GOOGL','BAC','WFC','CVX','UNH','HD','INTC','PFE','T','V','PG','VZ','CSCO','C','CMCSA','ABBV','BA','KO','DD','PEP','PM','MRK','DIS','WMT','ORCL','MA','MMM','NVDA','IBM','AMGN','MCD','GE','MO','NFLX','HON','MDT','GILD','TXN','ABT','UNP','SLB','BMY','RTX','AVGO','ACN','QCOM','ADBE','CAT','GS','PYPL','USB','UPS','LOW','NKE','TMO','LMT','COST','CVS','LLY','TSLA','CTLT','ETSY','TER'] 
	def SP500More(): return ['VNT','POOL','CTLT','ETSY','TER','BIO','TDY','TYL','WST','DXCM','DPZ','CARR','OTIS','IR','PAYC','LYV','STE','ZBRA','ODFL','WRB','N','W','LVS','NVR','CDW','IEX','LDOS','TMUS','MKTX','AMCR','CTVA','DD','DOW','WAB','ATO','TFX','FRC','CE','FANG','LW','MXIM','KEYS','FTNT','ROL','AMCR','CPRT','FLT','HFC','TWTR','EVRG','ABMD','MSCI','SIVB','TTWO','IPGP','HII','NCLH']
	...
	def Other():
		...
		r += TickerLists.SP500More()
		return r
	def Indexes():return ['^SPX','^DJI','^NDQ']
	def TopPerformers(): return ['CHTR','PG','MA','AVGO','MSFT','HD','QCOM','T','TXN','COST','V','TMO','FB','LMT','POR','PYPL','CMCSA','INTC','PEP','ABT','CAT','NKE','JPM','MRK','HON','BAC','MDT','TM','ACN','UNP','AES','WMT','TSLA']
